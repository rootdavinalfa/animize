...
public class home_lastup_adapter extends RecyclerView.Adapter<home_lastup_holder>{
    ...
    private ArrayList<HomeLastUploadModel> lastupdata;
    private int itemResor;
    private int pos;
    public home_lastup_adapter(ArrayList<HomeLastUploadModel>data, Context context, int itemResource){
    ...
    public void onBindViewHolder(@NonNull home_lastup_holder holder, int position) {
        pos = position;
        HomeLastUploadModel slm = this.lastupdata.get(position);
